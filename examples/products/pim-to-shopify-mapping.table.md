...
| Derived merchandising name | `Atlas Wool Rug` | Native product title | Build from approved PIM naming rules. | Title is core commerce presentation. | Confirm naming and translation strategy before real sync. |
