...
| [ADR-008](../decisions/ADR-008-shopify-checkout-and-customer-account-mvp.md) | Hydrogen MVP includes Shopify-hosted checkout redirect and Shopify-standard Customer Account API routes, while Shopify remains system of record.                  | Keeps basic ecommerce behavior inside Shopify's standard ownership boundary.                    |
