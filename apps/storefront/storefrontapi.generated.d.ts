...
export type CartApiQueryFragment = Pick<
  StorefrontAPI.Cart,
  'updatedAt' | 'id' | 'totalQuantity' | 'note'
> & {
  lines: {
    nodes: Array<
      | (Pick<StorefrontAPI.CartLine, 'id' | 'quantity'> & {
...
export type ProductDisplayAttributesFragment = {
  material?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  style?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
};

export type MoneyProductCardFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;
...
> & {
  ...
  pileHeightMm?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  suitableRooms?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  originCountry?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  images: {
    nodes: Array<
      Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
    >;
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      shape?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      pileHeightMm?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      suitableRooms?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      originCountry?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      images: {
        nodes: Array<
