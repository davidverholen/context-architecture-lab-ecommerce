...
Official Shopify documentation is the source of truth. Local docs are project interpretation only.

Use these official references before API-specific implementation:
